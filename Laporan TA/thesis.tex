...
\begin{document}
    ...
    \title{Identifikasi Meme \textit{Self-Harm} Menggunakan \textit{Intermediate Fusion} Model Multimodal CLIP dan ELECTRA}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Comparison }
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris

    % Informasi Mahasiswa
    \author{Elsa Elisa Yohana Sianturi}      % Nama Mahasiswa
    \nim{122140135}                           % NIM Mahasiswa

    %Informasi Dosen Pembimbing
    \dosbingA%
        {Martin Clinton Tosima Manullang, Ph.D.}%  % Nama Dosen Pembimbing 1
        {NIP. 19930109 201903 1 017}              % NIP Dosen Pembimbing 1
    \dosbingB%
    ...
    \pengujiA%
        {Leslie Anggraini, S.Kom., M.Cs.}%         % Nama Dosen Penguji 1
        {NIP. 19970817 202521 2 082}              % NIP Dosen Penguji 1
    \pengujiB%
        {I Wayan Wiprayoga Wisesa, S.Kom., M.Kom.}%          % Nama Dosen Penguji 2
        {NIP. 19890322 201903 1 009}              % NIP Dosen Penguji 2
